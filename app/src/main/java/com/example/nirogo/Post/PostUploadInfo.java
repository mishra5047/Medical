...
String docImageurl, docName, docSpec, time, desc, posturl, numberDoc;
int likes;
    ...
    public PostUploadInfo(String docimage, String number, String docName, String docSpec, String time, String desc, String url, int likes) {
